package com.jdkcc.ts.extra.aop;

import com.jdkcc.ts.dal.MResponse;
import com.jdkcc.ts.extra.enums.ErrorCode;
import com.jdkcc.ts.extra.exception.ServiceException;
...
public class ControllerAspect {
     ...
     * @return Map
     */
	@Around("execution(public com.jdkcc.ts.dal.MResponse" +
